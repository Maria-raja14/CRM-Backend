...
import { adminOrAssigned,adminOrSales } from "../middlewares/auth.middleware.js";
...
router.get("/getSingle/:id", protect, indexController.invoiceController.getInvoiceById);
router.put("/updateInvoice/:id", adminOrSales, indexController.invoiceController.updateInvoice);
