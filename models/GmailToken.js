...
const gmailTokenSchema = new mongoose.Schema({
  ...
  crm_user_id: {
    type: mongoose.Schema.Types.ObjectId,
    ref: "User",
    required: true,   // 🔒 REQUIRED — no orphan tokens allowed
    index: true,
  },
...
// 🔒 COMPOUND UNIQUE: one Gmail account per CRM user (a CRM user can only
//    connect one Gmail; the same Gmail cannot be shared across CRM users)
