...
//         access_type: 'offline',
//         prompt: 'consent', // force refresh token + scope update
//         scope: [
...
//       if (error) {
//         return res.redirect(`${process.env.FRONTEND_URL}/google-auth?error=denied`);
//       }
...
//       if (!user) {
//         return res.redirect(`${process.env.FRONTEND_URL}/google-auth?error=user_not_found`);
//       }
...
//       res.redirect(`${process.env.FRONTEND_URL}/google-auth?success=true`);
//     } catch (err) {
//       console.error('OAuth callback error:', err);
//       res.redirect(`${process.env.FRONTEND_URL}/google-auth?error=failed`);
//     }
//   },
